...
class TestWhisperEngine:
    ...
    @patch('backend.services.voice.stt.whisper_engine.whisper')
    def test_whisper_model_loads(self, mock_whisper):
        ...
        # Act
        from backend.services.voice.stt.whisper_engine import load_whisper_model
    ...
    @patch('backend.services.voice.stt.whisper_engine.torch')
    @patch('backend.services.voice.stt.whisper_engine.whisper')
