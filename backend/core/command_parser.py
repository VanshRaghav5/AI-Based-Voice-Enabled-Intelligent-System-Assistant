...
class CommandParser:
    ...
    Pipeline:
    1. Intent Recognition → Get tool name + confidence
    2. Parameter Extraction → Extract entities from command
    3. Parameter Validation → Validate extracted parameters
    4. Decision → Execute or request clarification
    """
