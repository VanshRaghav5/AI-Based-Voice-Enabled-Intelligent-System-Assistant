...
from backend.utils.settings import VOICE_RESPONSE_COOLDOWN_SECONDS
from backend.api.controllers.auth_service import AuthService, PasswordHasher
from backend.api.controllers.auth_middleware import login_required, admin_required
from backend.api.controllers.validation import (
    LoginSchema,
    RegisterSchema,
    CommandSchema,
    SettingsSchema,
...
def speak_text():
    ...
    try:
        ...
        from backend.services.voice_service import speak
...
def voice_loop(one_shot: bool = True, trigger: str = "manual"):
    ...
    from backend.services.voice_service import listen_for_gui_adaptive, speak
